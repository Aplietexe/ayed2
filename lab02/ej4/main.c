...
int main(int argc, char *argv[]) {
    ...
    /* Usando la idea de las líneas de códigos anteriores
       ...
       intercambios realizados) para insertion_sort. No te olvides que antes
       debes copiar el arreglo original, resetear los contadores y setear el
       tiempo.
    */
    /* reset the copy of the array */
    array_copy(copy, array, length);
